...
public class BottomRelativeLayout extends LinearLayout {
	...
	private OnClickListener answerOnClickListener;
	private OnClickListener hangUpOnClickListener;
	private OnClickListener switchCameraOnClickListener;
...
//		setWillNotDraw(false);
	...
	protected void onFinishInflate() {
		...
		ivSpeaker.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (isHandsfreeState){
					ivSpeaker.setImageResource(R.mipmap.em_icon_speaker_off);
				}else{
					ivSpeaker.setImageResource(R.mipmap.em_icon_speaker_on);
				}
		...
		ivLocalVideo.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (isLocalVideoOffState) {
					ivLocalVideo.setImageResource(R.mipmap.em_icon_local_video_off);
				} else {
					ivLocalVideo.setImageResource(R.mipmap.em_icon_local_video_on);
				}
	...
	public void setAnswerOnClickListener(OnClickListener listener){
		answerOnClickListener = listener;
	}

	public void setHangUpOnClickListener(OnClickListener listener){
